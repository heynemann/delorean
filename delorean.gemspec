...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["README", "lib/authorization.rb", "lib/console.rb", "lib/db.rb", "lib/domain.rb", "lib/messaging.rb", "lib/public/css/grid.css", "lib/public/img/background-top.png", "lib/public/img/background-white.png", "lib/public/img/delorean-logo-sm.png", "lib/public/img/delorean-logo.png", "lib/server.rb", "lib/views/about.haml", "lib/views/catalogue_list.haml", "lib/views/catalogue_new.haml", "lib/views/catalogue_show.haml", "lib/views/layout.haml", "lib/views/style.sass"]
  s.files = ["Gemfile", "Makefile", "Manifest", "README", "Rakefile", "delorean.gemspec", "features", "lib/authorization.rb", "lib/console.rb", "lib/db.rb", "lib/domain.rb", "lib/messaging.rb", "lib/public/css/grid.css", "lib/public/img/background-top.png", "lib/public/img/background-white.png", "lib/public/img/delorean-logo-sm.png", "lib/public/img/delorean-logo.png", "lib/server.rb", "lib/views/about.haml", "lib/views/catalogue_list.haml", "lib/views/catalogue_new.haml", "lib/views/catalogue_show.haml", "lib/views/layout.haml", "lib/views/style.sass", "spec/load_all_tests/load_all_1.txt", "spec/load_all_tests/load_all_2.txt"]
